...
//	       例List<String> array = new ArrayList<>();
...
//	　<以下記述>
		 ...
		 int indexOfFoo = array.indexOf("foo");
         System.out.println("fooのインデックス: " + indexOfFoo);
     }
...
//      問⑦ Calender型calを使い、int型配列arrayDateに今の年・月・日を入れてください。           Calendar cal = Calendar.getInstance();
//	    <以下記述>
